...
//start_
dependency "datadog-slo-acbalance" {
  config_path = "../slo/acbalance"
}
//fin
...
inputs = {
  dashboard_attributes = [
    //begin[
  {
    "title": "SLI - INFRAESTRUCTURA - CLI (Terraform)",
    ...
    "slos": [
      {
        ...
        "definition": {
          ...
          "slo_id": "${dependency.datadog-slo-acbalance.outputs.metric_based_slo.ISIIGOacbalanceCLI-Less-than-0_1-are-5xx-4xx-Terraform}",
